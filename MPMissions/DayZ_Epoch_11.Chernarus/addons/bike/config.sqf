...
DZE_DEPLOYABLES_CONFIG = [
    ...
    ["ItemToolbox",[0,6,1],5,0.3,false,false,false,false,false,true,true,["MMT_Civ"],[],["ItemToolbox"],"true"],
	["ItemToolbox",[0,6,1],5,0.3,false,false,false,false,false,true,true,["TT650_Ins"],[],["ItemToolbox"],"!(isNull player) && {(getPlayerUID player) in DZE_DEPLOYABLE_ADMINS}"],
    ...
    ["ItemToolbox",[0,8,2],7,0.2,false,true,false,false,false,true,true,["CSJ_GyroC"],[],["PartVRotor","PartEngine","PartFueltank"],"true"]
...
DZE_DEPLOYABLE_ADMINS = ["76561198302675871"];
