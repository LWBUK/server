...
DZE_SafeZonePosArray = [[[6325.6772,7807.7412,0],150],[[4063.4226,11664.19,0],150],[[11447.472,11364.504,0],150],[[1606.6443,7803.5156,0],150],[[12944.227,12766.889,0],150],[[12060,12640,0],40],[[6772.35,2494.58,0],20]]; //Prevent players in safeZones from being killed if their vehicle is destroyed. Format is [[[3D POS], RADIUS],[[3D POS], RADIUS]]; Ex. DZE_SafeZonePosArray = [[[6325.6772,7807.7412,0],150],[[4063.4226,11664.19,0],150]];
DZE_SafeZoneNoBuildItems = ["VaultStorageLocked","LockboxStorageLocked","Plastic_Pole_EP1_DZ"]; // Array of object class names not allowed to build near the safe zones listed above. i.e ["VaultStorageLocked","LockboxStorageLocked","Plastic_Pole_EP1_DZ"] etc.
DZE_SafeZoneNoBuildDistance = 700; // Distance from safe zones listed above to disallow building near.
...
"MAP_runway_main","MAP_runway_end15","WarfareBunkerSign"]; //Array of object class names that are blacklisted to build near. i.e ["Land_Mil_ControlTower","Land_SS_hangar"] etc.

DZE_NoBuildNearDistance = 700; // Distance from blacklisted objects to disallow building near.
...
Z_VehicleDistance = 50; // Max distance a vehicle can be sold or accessed from at a trader.
...
DZE_PlotManagementAdmins = ["76561198302675871","76561198028236135"]; //Array of admin PlayerUIDs. UIDs in this list are able to access every pole's management menu and delete or build any buildable with a pole nearby.
...
DZE_noRotate = ["ItemVault","Plastic_Pole_EP1_DZ"]; // List of objects (magazine classnames) that cannot be rotated. Example: ["ItemVault","ItemTent","ItemDomeTent","ItemDesertTent"];
...
DZE_doorManagementAdmins = ["76561198302675871","76561198028236135"]; //Array of admin PlayerUIDs. UIDs in this list are able to access every door's management menu and open it.
