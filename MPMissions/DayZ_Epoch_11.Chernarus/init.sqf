...
dayZ_serverName = "SD OP"; //Shown to all players in the bottom left of the screen (country code + server number)
...
//Temp settings
dayz_DamageMultiplier = 5; //1 - 0 = Disabled, anything over 1 will multiply damage. Damage Multiplier for Zombies.
...
DefaultWeapons = ["Makarov_DZ","Itemradio","ItemMap","Binocular","ItemToolbox"];
...
DZE_PlotPole = [40,300]; // Radius owned by plot pole [Regular objects,Other plotpoles]. Difference between them is the minimum buffer between bases.
DZE_BuildingLimit = 150; // Max number of built objects allowed in DZE_PlotPole radius


DZE_SelfTransfuse = true; // Allow players to bloodbag themselves
DZE_selfTransfuse_Values = [10000,10,120]; // [blood amount given, infection chance %, cooldown in seconds]
...
call compile preprocessFileLineNumbers "addons\bike\init.sqf"; //BIKE DEPLOY
...
if (!isDedicated) then {
	...
	execVM "SD\rpgfix.sqf";
	call compile preprocessFileLineNumbers "scripts\zsc\zscInit.sqf";
	call compile preprocessFileLineNumbers "scripts\zsc\bankInit.sqf";	
	call compile preprocessFileLineNumbers "scripts\logistic\init.sqf";// TOW
...
[] execVM "SD\safezones.sqf";
[]execVM "SD\marker.sqf";
[]execVM "SD\addbankmarkers.sqf";
_null = [] execVM "SD\bikefix\missionveh.sqf";
