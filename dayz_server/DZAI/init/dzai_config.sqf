...
DZAI_respawnLimit3 = 5; 	//Respawn limit for very high level AI in places with high-grade military loot (Default: -1)

//Spawn probabilities
DZAI_spawnChance0 = 0.10;	//Spawn chance for low-skill AI typically found in small towns (Default: 0.40)
DZAI_spawnChance1 = 0.30;	//Spawn chance for mid-level AI typically found in cities and large towns (Default: 0.60)
DZAI_spawnChance2 = 0.20;	//Spawn chance for high-level AI typically found in places with military-grade loot (Default: 0.80)
DZAI_spawnChance3 = 0.30;	//Spawn chance for expert-level AI found in areas with high-grade military loot (Default: 0.90)
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_Pistols0 = ["Makarov","revolver_EP1"]; 				//Weapongrade 0 pistols
DZAI_Pistols1 = ["M9","M9SD","MakarovSD","PDW_DZ","G17_FL_DZ"]; 	//Weapongrade 1 pistols
DZAI_Pistols2 = ["M9SD","MakarovSD","PDW_DZ","G17_FL_DZ"]; 		//Weapongrade 2 pistols
DZAI_Pistols3 = ["M9SD","MakarovSD","PDW_DZ","G17_FL_DZ"]; 		//Weapongrade 3 pistols

DZAI_Rifles0 = ["LeeEnfield","Winchester1866","MR43","LeeEnfield","Winchester1866_DZ","MR43"]; //Weapongrade 0 rifles
DZAI_Rifles1 = ["M16A2_DZ",
"M16A2_GL_DZ",
"AK74_DZ",
"M4A1_CCO_DZ",
"AK74_Kobra_DZ",
...
"MP5_DZ",
"MP5_SD_DZ",
"M4A3_CCO_EP1"]; //Weapongrade 1 rifles
DZAI_Rifles2 = ["M16A2_DZ",
"M16A2_GL_DZ",
"M249_DZ",
"AK74_DZ",
"M4A1_CCO_DZ",
...
"M40A3_Gh_DZ",
"SA58_DZ",
"SA58_DZ"]; //Weapongrade 2 rifles
DZAI_Rifles3 = ["FNFAL_DZ",
"FN_FAL_ANPVS4_DZE",
"Mk48_CCO_DZ",
"M249_DZ",
"L85_Holo_DZ",
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
DZAI_Edibles = ["ItemSodaCoke", "ItemSodaPepsi", "ItemWaterbottle", "FoodCanSardines", "FoodCanBakedBeans", "FoodCanFrankBeans", "FoodCanPasta","FoodBeefCooked", "ItemWaterbottleUnfilled","ItemWaterbottleBoiled","FoodCanUnlabeled","FoodPistachio","FoodNutmix","FoodMRE"];
