if(isServer) then {
	...
	/* AI CONFIG */
		...
		ai_roadkill_damageweapon	= 70;			// percentage of chance a roadkill will destroy weapon AI is carrying
	...
	/* WAI MISSIONS CONFIG */
		...
		wai_avoid_traders			= 2000;								// avoid spawning missions this close to traders
		...
		wai_mission_timer			= [30,600];							// time between missions 5-15 minutes
        ...
        crate_items_stronghold      = ["ItemObsidian","ItemVault","ItemBriefcase100oz","plot_pole_kit","ItemHotwireKit","ItemTopaz","ItemDocument"];
