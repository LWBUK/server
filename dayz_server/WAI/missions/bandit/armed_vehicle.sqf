if(isServer) then {
	...
	[[_position select 0,_position select 1,0],5,"Extreme",["Random","AT"],3,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],4,"Medium","Random",3,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],3,"Medium","Random",3,"Random","Hero","Random","Hero",_mission] call spawn_group;
