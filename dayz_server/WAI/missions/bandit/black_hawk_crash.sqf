if(isServer) then {
	...
	//Troops
	[[_position select 0,_position select 1,0],2,"Medium",["Random","AT"],4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],2,"Medium","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],2,"Medium","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
