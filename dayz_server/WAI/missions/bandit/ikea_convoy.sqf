if(isServer) then {
	...
	[[_position select 0,_position select 1,0],2,"Hard",["Random","AT"],4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	...
	//Heli Para Drop
	[[(_position select 0),(_position select 1),0],[0,0,0],400,"BAF_Merlin_HC3_D",8,"Random","Random",4,"Random","Hero","Random","Hero",false,_mission] spawn heli_para;
	[[(_position select 0),(_position select 1),0],[0,0,0],400,"BAF_Merlin_HC3_D",5,"Random","Random",4,"Random","Hero","Random","Hero",false,_mission] spawn heli_para;
