if(isServer) then {
	...
	[[_position select 0,_position select 1,0],5,"Extreme",["Random","AT"],3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	for "_i" from 0 to _rndgro do {
		[[_position select 0,_position select 1,0],5,"hard","Random",3,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	};
