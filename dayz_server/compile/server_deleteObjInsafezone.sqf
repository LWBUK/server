...
_safespot = [6697.31,14113.6,0.00140381];
...
//			diag_log format["%2: Cleanup zones for chernarus selected! (check: %1)",_WorldName,_txt]; //logging if right worldname was selected, if uncommented
			HALV_VEHICLE_CLEANUPZONES = [
			//position					radius		cityname/text
			[[6325.6772,7807.7412,0],	150,		"Trader City Stary"],
			[[4063.4226,11664.19,0],	150,		"Trader City Bash"],
			[[11447.472,11364.504,0],	150,		"Trader City Klen"],
			[[1606.6443,7803.5156,0],	150,		"Bandit Camp"],
			[[12944.227,12766.889,0],	150,		"Hero Camp"],
			[[13441.16,5429.3013,0],	50,		"Wholesaler East"],
			[[12060,12638,0],	50,		"Aircraft Dealer"],
			...
			[[6569,14216,0],            50,      "Super Hero Trader"]
			];
		};
//tavi
		case "tavi":{
