...
execVM "\z\addons\dayz_server\bankzones\Chernarus.sqf";
	...
	_nil = [] ExecVM "\z\addons\dayz_server\map\BalotaAF.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\map\traderstary.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\map\donorAF.sqf";

	_nil = [] ExecVM "\z\addons\dayz_server\map\balota.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\map\basedichina.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\map\basenovy.sqf";

	_nil = [] ExecVM "\z\addons\dayz_server\map\nwaf.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\map\valley.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\map\krutoy.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\map\pulkovo.sqf";